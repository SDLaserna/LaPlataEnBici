...
@ManagedBean
@RequestScoped
/*Por cada click en el bot√≥n registrar, manda un request y se crea una conexion.
...
public class UsuarioMb {
	...
	public String registrar(){
		...
		if (this.usuarioService.existePersona(this.getUsuario().getEmail())){
			...
			FacesMessage mensaje = new FacesMessage("Te registrate correctamente, se te ha generado una contraseÒa");
			FacesContext.getCurrentInstance().addMessage("Registro", mensaje);
			return "success";
			}
	}
