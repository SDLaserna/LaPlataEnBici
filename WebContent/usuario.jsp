...
<div>
        ...
        <div id="header-topbar-option-demo" class="page-header-topbar">
            ...
            <div class="navbar-header">
                ...
                <a id="logo" href="index.html" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text">LaPlataEnBici</span><span style="display: none" class="logo-text-icon">µ</span></a></div>
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    </i><span class="menu-title">Listado de Estaciones</span></a></li>
                    <li><a href="Layout.html"><i class="fa fa-desktop fa-fw">
                        <div class="icon-bg bg-pink"></div>
                    </i><span class="menu-title">Mapa de Estaciones</span></a>
            ...
            <div id="page-wrapper">
                ...
                <div id="footer">
                    <div class="copyright">
                        <a href="http://themifycloud.com">2015 © Java y Aplicaciones Avanzadas sobre Internet</a></div>
                </div>
                <!--END FOOTER-->
            </div>
            <!--END PAGE WRAPPER-->
